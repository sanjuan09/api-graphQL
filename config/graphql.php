...
return [
    ...
    'schemas' => [
        'default' => [
            ...
            'mutation' => [
                \App\GraphQL\Mutations\TicketCreate::class,
                \App\GraphQL\Mutations\TicketUpdate::class,
                \App\GraphQL\Mutations\TicketDelete::class,
            ],
            // The types only available in this schema
            'types' => [
                \App\GraphQL\Types\TicketsType::class,
            ],
